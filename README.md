...
**N.B.** Conformal prediction doesn't substitute any of the training algorithms that we explained previously, but rather represent a methodology to assign confidence to prediction produced by a model that was trained with a any machine learning algorithm. 
